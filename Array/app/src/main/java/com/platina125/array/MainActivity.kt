...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // intArray 변수에는 1부터 10까지의 값이 각각의 배열공간에 저장되어 있다
        ...
        //4. 값 변경해보기
        intArray[7] = 137 // 6번 인덱스인 7번째 값 7이 137로 변경됨
        intArray.set(9,200) // 9번 인덱스인 10번째 값 8이 200으로 변경됨

        //5. 배열 값 사용하기
        var seventhValue = intArray[7]
        Log.d("Array","7번째 intArray의 값은 ${seventhValue}입니다")
        var tenthValue = intArray.get(9)
        Log.d("Array","10번째 intArray의 값은 ${tenthValue}입니다")

        Log.d("Array","1 dayArray의 값은 ${dayArray[0]}입니다")
